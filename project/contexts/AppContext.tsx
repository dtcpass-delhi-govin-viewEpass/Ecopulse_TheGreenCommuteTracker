...
export const [AppProvider, useApp] = createContextHook(() => {
  ...
  const registerMutation = useMutation({
    mutationFn: async (userData: Omit<User, 'id' | 'createdAt'>) => {
      ...
      await AsyncStorage.setItem(STORAGE_KEYS.COMMUNITY_STATS, JSON.stringify(updatedStats));
  ...
  const addCommuteLogMutation = useMutation({
    mutationFn: async (logData: Omit<CommuteLog, 'id' | 'userId' | 'createdAt'>) => {
      ...
      await AsyncStorage.setItem(STORAGE_KEYS.COMMUTE_LOGS, JSON.stringify(updatedLogs));
