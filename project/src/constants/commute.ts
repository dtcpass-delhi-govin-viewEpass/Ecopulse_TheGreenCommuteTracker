export const COMMUTE_MODES = [
  { id: 'walking', label: 'Walking', icon: '🚶', co2Factor: 0 },
  { id: 'biking', label: 'Biking', icon: '🚴', co2Factor: 0 },
  { id: 'public-bus', label: 'Public Bus', icon: '🚌', co2Factor: 0.089 },
  { id: 'metro', label: 'Metro/Train', icon: '🚇', co2Factor: 0.041 },
  { id: 'car', label: 'Car (Petrol)', icon: '🚗', co2Factor: 0.171 },
  { id: 'ev', label: 'Electric Vehicle', icon: '⚡', co2Factor: 0.053 },
  { id: 'motorcycle', label: 'Motorcycle', icon: '🏍️', co2Factor: 0.113 },
  { id: 'carpool', label: 'Carpool', icon: '👥', co2Factor: 0.085 },
] as const;
