...
import { Trophy, Medal, Award, Calendar, Clock, TrendingUp } from 'lucide-react-native';
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      >
        ...
        <Text style={styles.headerSubtitle}>Leading the way to a greener future</Text>
      </LinearGradient>
            ...
            <View style={[styles.userRankCard, getRankStyle(userRank.rank)]}>
              <View style={styles.userRankInfo}>
                ...
                <View style={styles.userRankDetails}>
                  ...
                  <Text style={styles.userRankCO2}>{userRank.totalCO2Saved.toFixed(1)} kg CO₂</Text>
                </View>
              </View>
            </View>
          </View>
        ...
        <View style={styles.leaderboardSection}>
          ...
          {leaderboardData.map((item, index) => (
            <View key={item.userId} style={[styles.leaderboardItem, getRankStyle(item.rank)]}>
              <View style={styles.rankContainer}>
                {getRankIcon(item.rank)}
              </View>
              
              <View style={styles.userInfo}>
                <Text style={[styles.userName, item.userId === user?.id && styles.currentUser]}>
                  {item.userName}
