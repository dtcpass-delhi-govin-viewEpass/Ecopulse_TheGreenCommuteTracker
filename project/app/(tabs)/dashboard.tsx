...
import { Leaf, Users, TrendingUp, Calendar, Award, Settings, X } from 'lucide-react-native';
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.headerSubtitle}>Making a difference, one trip at a time</Text>
      </LinearGradient>
